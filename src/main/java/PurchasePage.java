...
public class PurchasePage extends javax.swing.JPanel {
    ...
    public PurchasePage(Dashboard dashboard) {
        ...
        jLabel7.setText("Precio de coste:");
    ...
    private void purchaseButtonActionPerformed(java.awt.event.ActionEvent evt) {                                               
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Por favor agregue este producto en el \"Products\" sección antes de continuar.");
    ...
    private void codeTextKeyReleased(java.awt.event.KeyEvent evt) {                                     
        try {
            ...
            if (resultSet.next()) {
                nameText.setText(resultSet.getString("nombre del producto"));
                costText.setText(String.valueOf(resultSet.getDouble("precio de coste")));
                sellText.setText(String.valueOf(resultSet.getDouble("precio de venta")));
            } else {
                nameText.setText("");
                costText.setText("");
                sellText.setText("");
